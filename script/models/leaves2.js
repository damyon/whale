...
class Leaves2 extends Drawable {
  ...
  initBuffers(gl) {
    ...
    for (i = 0; i < this.treeLOD; i++) {
      offsetX = Math.sin(i * one) * this.treeSize / 5 + skew;
      offsetZ = Math.cos(i * one) * this.treeSize / 5 - skew;
      offsetY = 1.4 + this.treeOffset;
      treePositions[offset++] = offsetX;
      treePositions[offset++] = offsetY;
      treePositions[offset++] = offsetZ;

      offsetX = Math.sin((i + 1) * one) * this.treeSize / 5 + skew;
      offsetZ = Math.cos((i + 1) * one) * this.treeSize / 5 - skew;
      offsetY = 1.4 + this.treeOffset;
      treePositions[offset++] = offsetX;
      treePositions[offset++] = offsetY;
      treePositions[offset++] = offsetZ;
